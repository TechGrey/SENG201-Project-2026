...
This project contains default naming of `team99` throughout.
If you are interested you can update this to reflect your team number, however it is **not required**.
This can be done by renaming any instance of `team99` with `team<x>` (where x is your number).
...
## Build and Run Jar
1. Open a command line interface inside the project directory and run `./gradlew jar` to create a packaged Jar. The Jar file is located at build/libs/seng201_team99-1.0-SNAPSHOT.jar
2. Navigate to the build/libs/ directory (you can do this with `cd build/libs`)
3. Run the command `java -jar seng201_team99-1.0-SNAPSHOT.jar` to open the application.
